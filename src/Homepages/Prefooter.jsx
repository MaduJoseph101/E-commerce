...
function Prefooter() {
  return (
    <section className='min-h-[75vh] w-full bg-[#F4F4EC] grid grid-cols-1 sm:grid-cols-2 overflow-hidden font-jakarta'>
      ...
      <div className='flex flex-col justify-center items-start p-8 sm:p-12 lg:p-16 gap-4 sm:gap-6 bg-[#F4F4EC] text-black font-jakarta z-10'>
        <h2 className='font-jakarta text-2xl sm:text-4xl lg:text-4xl font-bold leading-[1.15] tracking-tight text-gray-950'>
          The 2026 AllShoes Comfort & Performance Collection
        </h2>
